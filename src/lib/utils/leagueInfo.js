/*   STEP 1   */
export const leagueID = "785921175959277568"; // your league ID
export const leagueName = "Langen dynasty idp league"; // your league name
...
export const managers = [
     {
       ...
       "location": "Frankfurt", // (optional)
       "bio": "Your 2021 Champion!",
       "photo": "/managers/saschaNeu.jpg", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2016, // (optional) when did the manager start playing fantasy football
       "favoriteTeam": "pit", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
       "mode": "Dynasty", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
         name: "AAaaalleee", // Can be anything (usually your rival's name)
       ...
       "philosophy": "Flach spielen, hoch gewinnen",
